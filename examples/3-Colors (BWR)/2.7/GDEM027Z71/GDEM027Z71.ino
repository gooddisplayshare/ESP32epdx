...
void loop() {
    ...
    for(i=0;i<6;i++)
			EPD_Dis_Part_Num(96,160+32*0,Num[5-i],         //x-A,y-A,DATA-A
											 96,160+32*1,Num[i],         //x-B,y-B,DATA-B
											 96,160+32*2,gImage_dot, //x-C,y-C,DATA-C
											 96,160+32*3,Num[1],32,64); //x-D,y-D,DATA-D,Resolution  32*64
			EPD_Dis_Part_Num(96,160+32*0,Num[8],         //x-A,y-A,DATA-A
										   96,160+32*1,Num[1],         //x-B,y-B,DATA-B
										   96,160+32*2,gImage_dot, //x-C,y-C,DATA-C
										   96,160+32*3,Num[2],32,64); //x-D,y-D,DATA-D,Resolution  32*64					
