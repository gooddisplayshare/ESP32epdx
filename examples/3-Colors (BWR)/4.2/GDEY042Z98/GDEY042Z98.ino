...
void loop() {
    ...
    EPD_SetRAMValue_BaseMap(gImage_BWbasemap,gImage_RWbasemap); //Please do not delete the background color function, otherwise it will cause unstable display during partial update.
		for(i=0;i<6;i++)
		EPD_Dis_Part_Num(48*0,144,Num[1],         //x-A,y-A,DATA-A
											48*1,144,gImage_dot, //x-C,y-C,DATA-C
											48*2,144,Num[i],        //x-D,y-D,DATA-D
											48*3,144,Num[5-i],104,48); //x-E,y-E,DATA-E,Resolution  32*64   
																													
		EPD_Dis_Part_Num(48*0,144,Num[2],         //x-A,y-A,DATA-A
											48*1,144,gImage_dot, //x-C,y-C,DATA-C
											48*2,144,Num[2],        //x-D,y-D,DATA-D
											48*3,144,Num[8],104,48); //x-E,y-E,DATA-E,Resolution  32*64   
