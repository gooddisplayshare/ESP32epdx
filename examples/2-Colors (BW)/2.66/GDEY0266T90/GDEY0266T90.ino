...
///////////////////////////GUI///////////////////////////////////////////////////////////////////////////////////
   //Data initialization settings
    ...
    Paint_DrawNum(0, 70, 123456789, &Font8, WHITE, BLACK);  //Font8
    Paint_DrawNum(0, 80, 123456789, &Font12, WHITE, BLACK); //Font12
    Paint_DrawNum(0, 95, 123456789, &Font16, WHITE, BLACK); //Font16
    Paint_DrawNum(0, 115, 123456789, &Font20, WHITE, BLACK); //Font20
    EPD_HW_Init_GUI(); //EPD init GUI
    EPD_Display(ImageBW); //display image
    EPD_DeepSleep();//EPD_DeepSleep,Sleep instruction is necessary, please do not delete!!!
    delay(2000); //2s    
